      ...
      <section className="max-w-4xl w-full flex flex-col mx-auto pt-44">
        ...
        >
          <h1 className="font-bold lg:text-7xl md:text-6xl sm:text-5xl text-4xl">
            Hey, I&apos;m Dominic<span className="sm:hidden inline-block animate-wave ml-2">👋</span><span className="sm:inline-block hidden animate-wave ml-2">👋</span>
          </h1>
          <p className="font-semibold lg:text-3xl md:text-2xl sm:text-xl text-lg min-h-[3.5em] sm:min-h-0">
            {inView &&
              <Typewriter
                options={{
                  delay: 50,
                  strings: [
                    "I'm a 17 year old full-stack dev located in Chicago",
          ...
          <ul className="flex flex-row flex-wrap gap-2 mt-2 list-none">
            ...
            />
            <SocialIcon
              url="https://steamcommunity.com/id/webdevaiden"
            ...
            */}
            <SocialIcon
              url="https://discord.com/invite/sirensoftware"
